Selenium Maven Template Project
===============================
...
- The maven-failsafe-plugin will pick up any files that end in IT by default (but you can customize this).
...
To run tests on selenium stand alone : 
This project will download drivers for you : the IEDriverServer, MicrosoftWebDriver, chromedriver , operachromium, or wires binaries.

To run tests on a selenium grid:  
You can specify a grid to connect to where you can choose your browser, browser version and platform:

- -Dremote=true 
- -DseleniumGridURL=http://{username}:{accessKey}@grid.selenium.com:4444/wd/hub 
- -Dplatform=WINDOWS 
- -Dbrowser=firefox 
